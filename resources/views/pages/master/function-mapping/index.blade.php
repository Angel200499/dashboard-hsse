...
<div class="space-y-6">
    ...
    @php
        ...
        $kelompokColors = [
            'GM' => 'bg-indigo-50 border-indigo-200 text-indigo-700',
        ];
    @endphp
                ...
                <table class="w-full text-sm">
                    <thead>
                        <tr class="bg-slate-50 border-b border-slate-100">
                            ...
                            <th class="px-5 py-3 text-left text-xs font-semibold text-slate-500 uppercase tracking-wider">Kelompok Khusus</th>
                    ...
                    <tbody class="divide-y divide-slate-100">
                        ...
                        @php
                            $badge         = $fungsiColors[$mp->fungsi_dashboard] ?? null;
                            $kelompokBadge = $kelompokColors[$mp->kelompok_khusus] ?? null;
                        @endphp
                        <tr class="hover:bg-slate-50/60 transition-colors group">
                            ...
                            <td class="px-5 py-3.5">
                                @if($kelompokBadge)
                                    <span class="inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-xs font-semibold border {{ $kelompokBadge }}">
                            ...
                            <td class="px-5 py-3.5 text-center">
                                <div class="flex items-center justify-center gap-2 opacity-80 group-hover:opacity-100 transition-opacity">
                                    ...
                                    <button
                                        ...
                                        data-kelompok-khusus="{{ $mp->kelompok_khusus ?? '' }}"
                                    >
            ...
            <form method="POST" action="{{ route('master.function-mapping.store') }}" id="form-create">
                ...
                <div class="px-6 py-5 space-y-5">
                    ...
                    <div class="border-t border-slate-100 pt-4">
                        <p class="text-xs font-semibold text-slate-500 uppercase tracking-wider mb-4">Pilih salah satu atau keduanya</p>

                        {{-- Fungsi Dashboard --}}
                        <div class="mb-4">
                            <label for="create-fungsi-dashboard" class="block text-sm font-medium text-slate-700 mb-1.5">
                                Fungsi Dashboard
                                <span class="ml-1 text-xs font-normal text-slate-400">(opsional jika kelompok khusus dipilih)</span>
                            </label>
                            <select
                            ...
                            <p class="text-xs text-slate-400 mt-1">Salah satu dari 4 fungsi utama Dashboard HSSE</p>
                        </div>
                        ...
                        <div class="bg-indigo-50/50 border border-indigo-100 rounded-xl p-4">
                            <div class="flex items-center gap-2 mb-2">
                                ...
                                <label for="create-kelompok-khusus" class="block text-sm font-medium text-indigo-700">
                                    Kelompok Khusus
                                </label>
                            </div>
                            <select
                                id="create-kelompok-khusus"
                                name="kelompok_khusus"
                                class="w-full text-sm border border-indigo-200 rounded-lg px-3 py-2.5 text-slate-700 bg-white focus:outline-none focus:ring-2 focus:ring-indigo-300/50 focus:border-indigo-400 transition"
                            >
                                <option value="">— Tidak ada —</option>
                                @foreach($kelompokKhususList as $kk)
                                    <option value="{{ $kk }}" {{ old('kelompok_khusus') === $kk ? 'selected' : '' }}>{{ $kk }}</option>
                                @endforeach
                            </select>
                            <p class="text-xs text-indigo-400 mt-1.5">
                                Kelompok khusus <strong>bukan</strong> fungsi dashboard. Contoh: GM untuk Area Lahendong.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="border-t border-slate-100 pt-4">
                        ...
                        <div class="bg-indigo-50/50 border border-indigo-100 rounded-xl p-4">
                            <div class="flex items-center gap-2 mb-2">
                                ...
                                <label for="edit-kelompok-khusus" class="block text-sm font-medium text-indigo-700">
                                    Kelompok Khusus
                                </label>
                            </div>
                            <select
                                id="edit-kelompok-khusus"
                                name="kelompok_khusus"
                                class="w-full text-sm border border-indigo-200 rounded-lg px-3 py-2.5 text-slate-700 bg-white focus:outline-none focus:ring-2 focus:ring-indigo-300/50 focus:border-indigo-400 transition"
                            >
                                <option value="">— Tidak ada —</option>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    document.querySelectorAll('.btn-edit').forEach(function (btn) {
        btn.addEventListener('click', function () {
            ...
            const kelompokKhusus  = this.dataset.kelompokKhusus;
            ...
            // Isi kelompok khusus
            const editKelompokKhusus = document.getElementById('edit-kelompok-khusus');
            if (editKelompokKhusus) editKelompokKhusus.value = kelompokKhusus;
