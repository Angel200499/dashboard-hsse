...
class UpdateMasterManpowerRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            // Unique rule di `bulan` dengan where() untuk cek kombinasi fungsi+tahun+bulan
            // ignore() mengecualikan record yang sedang diedit agar tidak konflik dengan dirinya sendiri
            'bulan' => [
                'required',
                'integer',
                'between:1,12',
